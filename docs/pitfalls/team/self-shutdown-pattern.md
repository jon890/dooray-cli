...
triggers: [self-shutdown, code-reviewer, architect, docs-verifier, run_in_background]
...
**우회**: 검사 결과 준비 시점에 즉시 새로 spawn (idle 대기 의존 금지). 죽었다는 시스템 알림 받으면 침묵 말고 새로 스폰하고 즉시 검사 지시 묶음.
