...
phase-01 / phase-02 와 동일 6 패턴 처방을 외부 노출 docs 2개에 적용 + task 034 완료 마킹.
...
- 명령 사용 예 (코드 블록) 은 그대로 — 코드는 6 패턴 미적용
...
CLAUDE.md "docs / ADR 작성 형식" 6 패턴 적용 (phase 3/3, final):
...
# 기대: 1
grep -cE "6 패턴 처방" .claude/skills/planning/SKILL.md
# 기대: 1
